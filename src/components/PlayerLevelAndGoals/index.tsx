...
interface PlayerLevelAndGoalsProps {
  totalGoals: number
  seasonGoals?: number
  roundGoals: number
  hourlyGoals: number
...
export function PlayerLevelAndGoals({
  totalGoals,
  roundGoals,
  hourlyGoals,
  money = 22569,
    ...
    <div className={styles.playerData}>
      ...
      <table>
        <tbody>
          ...
          <tr>
            <td>Dinheiro</td>
            <td className={styles.moneyAmount}>{money}</td>
          </tr>
        </tbody>
      </table>
    </div>
